  ...
  enableSoftBrush() {
    ...
    var drawPoints = (x, y, ctx) => {
      ...
      for (var i = 0; i < dist; i += Math.max(1, this.size / 10) ) {
        ...
        console.log(this.size / 2 + (this.size / 2 / 2 * this.hardness))
        ...
        for (let i = 0; i < Math.max(1, this.size / 2 + (this.size / 2 / 2 * this.hardness)); i++) {
          ...
          if (i >= Math.max(1, this.size / 2) - 1) opacity = 1;
    ...
    var drawCursor = (x, y, ctx) => {
      ...
      console.log(`rgba(${this.cursorColor[0]}, ${this.cursorColor[1]}, ${this.cursorColor[2]}, ${this.cursorColor[3]})`)
