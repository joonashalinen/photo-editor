...
class PhotoEditor extends React.Component {
  ...
  componentDidMount() {
    ...
    var previousTool = this.state.selectedTool;
    var canvasesContainer = document.getElementById("canvasesContainer");

    document.addEventListener("keydown", (e) => {
      if (e.code === "Space") {
        e.preventDefault();
        if (this.state.selectedTool === "view") return;
        previousTool = this.state.selectedTool;
        this.setState({
          selectedTool: "view"
        });
        canvasesContainer.style.cursor = "default";
      }
    });
  ...
  zoom = (e) => {
    ...
    console.log(this.offsetLeftOriginX, this.offsetX, this.offsetLeftOriginY, this.offsetY)
    ...
    console.log(scaleOffsetX, scaleOffsetY)
    ...
    return (
      <div id="mainContainer" className="mainContainer">
        <div className="upperRow" style={{position: "relative"}}>
          ...
          <div className="toolIcons" style={{marginTop: "17px"}}>
            ...
            <Tooltip title="Zoom [Z]">
              <div className="toolIconContainer">
                <img className="toolIcon" src="search-alt.svg" height="18px" onClick={() => {
                  if (!this.state.imageInstanced) return;
                  this.rotate();
                }}></img>
              </div>
            </Tooltip>
            <Tooltip title="Effects & Filters">
